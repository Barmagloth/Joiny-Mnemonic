...
`EvidenceConsolidator` автоматически обрабатывает только явные evidence-bound candidates:
структурированный `payload.memory_candidates` либо маркированные строки `Goal:`, `Constraint:`,
`Decision:`, `TODO:`, `Fact:`, `Preference:`. Он создаёт sourced memory и новые версии active
blocks. Неявный LLM extraction в core отсутствует.
